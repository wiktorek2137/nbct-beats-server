        ...
        if (res.length) {
            ...
            connection.query(selectAllOrdersInfo, (error, response) => {
                ...
                const ordersDetails = response.map(row => {
                    ...
                    <td class="montserrat-light black-text"><a style="color: #FF3D00" download href="${link}">Pobierz</a></td>
                </tr>`)
                })
            ...
            <tr>
                ...
                const mailOptions = {
                    from: 'no-reply@nobocoto.pl', //email
                    to: userEmail,
                    subject: `Zamówienie #${orderId} | NBCT Beats`,
                    html: `<!DOCTYPE html><html lang="pl"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet"><title>NBCT BEATS</title><style>body {font-family: 'Montserrat', Arial, sans-serif;margin: 0;padding: 0;box-sizing: border-box;}table {width: 100%;border-collapse: collapse; text-align: center;}.mail-header, .mail-footer, .mail-content {max-width: 600px;margin: 20px auto;overflow: hidden;}.mail-header, .mail-footer {text-align: center;padding: 20px;border-bottom: 1px solid #EBEBEB; /* Only for header */}.mail-header-desc{align: left;max-width: 600px;margin: 20px auto;overflow: hidden;}.mail-header {align: center;}.mail-footer {background-color: black;color: white;border: none;}.mail-content {padding: 20px;background-color: #FFFFFF;}.montserrat-light, .montserrat-bold {font-weight: 300;text-decoration: none;color: inherit;}.montserrat-bold {font-weight: 700;}td, th {padding: 10px 0;}.price{text-align: right;}.order-item td {border-top: 1px solid #EBEBEB;border-bottom: 1px solid #EBEBEB;}.black-text{color: black;}.white-text{text-decoration: none;color: white;}.logo{width: 300px;}</style></head><body><div class="mail-header"><img src="https://ci3.googleusercontent.com/mail-img-att/AGAZnRrMnEfo179QEea2qthnAxJ-cskaZf3nwwMWcYCZ-QKh5lH25dx_zu9i_Su-jop6S3jOW4HoP0KaFhXB9Yh20URbmNAt4EO5g8yZQzU1F0ydS_7jN9gFrnqC3bn72Wj9uXJFnKNGH-wjsqFzVvF7z4HHIKOlKRTiz2aUbHrxR6M7GHL_pl87n8UlmnRCrk2s5CNQwgrWDA-r51WghP3BPa1n9O8iWTgxzzOog0z4SjFDHR3NyEkir4wLipF2UhC6lbvGBr-MTNqi9aNEb1bTPAuXre6vNRjc9sJPZcmwruYyJoYXKHm1jcpXSwM5q697AVTd9fXcEH_mXq_Zqpce_5KgQr97qrmDpEsHedFYoxDlKXoJBsxtvtBSB9AIiOvNxPexarJNaiHMCjwPNdvqkyDjXWP4fOAbWfK4T_EBtKTaJqMgQrvIARB5PdKx6ZSjCI9BiB2aD12z7v-4k91WOR6t9ns1zbpYUp19uYNpjHsV6S4XoHAqsEDaSzNzZxJWlpoxY5Lwyzagi1jJFGpPV5pMjlVAwuiIoR_y0LsNQx65acyXJQaVgjXHYlYkjt_Fo7cfSZeAAcz5iz7yzIuF-EdiVaIKFaVw1Jny5oKA0wuxWkvxpIxdSKRKeynKpX_viZrNwYB2A65bJLv1PX-_hNJlkVOolaTGBv7Jj2euMsIoa_3XVyp6xnWq0L4f35csFv4LuC89JlMlnVet-XyuMgBeOiqFQ4-wlppZ8UBfKn2zDnGA0PPwHpZdtvit_u-xqegbL4JRXA1IWiRBB3DksK1VRov1EhUQuidwmZKsYTGKoLWfgnqzbLTR6_rdopWvLGNcTcKynL6ccq9rk02xWiB5hY6vIwrWyiBL7VC1r6WtAFCPwfk3I6olpbQcMp6rTIEc6LGfd5IATnuJeWZEGRjnOB5vez5SdAWMkTOkhx7TOGmRhh3FsLmtD-ON61_bYYzNfdOG1C1g70egV9xH_nkh1B0GkOEjTN5TNQKWbkWnvwaVB61yX0CM0u0U3TeDrs29nagGX-0V_8L_V0W-kzlQGY6Z74PVTAV0zE7n4ofezWYHblUKR6aRA3X5GqOHrugR8DLUbI6Pkm8MtdhZF4njb1FAn5g177GXu3x-9cMkVNEB3YMAknJd9nTBFSajCPmK42JA1YMxpN0d2-2dKmfraHq9c-8zm9jP5-Y2cC4wF1x6d9lexwhcU3PHnnsL8cXrNXstRzKxsZftkN-ZpbxxnOlreHOTIEJW4PpPLwK7YWiW7PKyODeXV4XZs4tUtBWfBylg3bba08ZKA0xDdUo9eaYgNJt6abmWyuU350wudQb4Nnk=s0-l75-ft" class="logo"></div><div class="mail-header-desc">${messageHeader}</div><div class="mail-content"><!-- Content here --><table>${ordersDetails.join('')}</table></div><div class="mail-footer"><a style="color: #FF3D00" href="https://beaty.nobocoto.pl" class="white-text">Odwiedź naszą stronę</a></div></body></html>`
                };
